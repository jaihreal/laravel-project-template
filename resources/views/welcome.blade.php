		...
		<body>
											...
											<div class="col-12 text-center">
													...
													<div class="d-flex justify-content-center flex-column mb-6 mb-lg-5">
															<a href="https://themesberg.com" target="_blank">
																	<img src="{{ asset('img/themesberg.svg') }}" class="d-block mx-auto mb-3" height="25" width="25" alt="Themesberg Logo">
					...
					<div class="section pt-0">
							<div class="container mt-n10 mt-lg-n12 z-2">
									<div class="row justify-content-center">
											<div class="col-12">
													<img src="{{ asset('img/mockup-presentation.png') }}" alt="Mockup presentation">
											</div>
									</div>
							</div>
					</div>
									...
									<div class="row justify-content-between align-items-center mb-5 mb-lg-7">
											<div class="row justify-content-between align-items-center">
													...
													<div class="col-lg-6 order-lg-1">
															<img src="{{ asset('img/illustrations/bs5-illustrations.svg') }}" alt="Front pages overview">
													</div>
											</div>
											...
											<div class="col-lg-6">
													<img src="{{ asset('img/mockup-kanban-presentation.png') }}" alt="Kanban Preview">
											</div>
									</div>
									<div class="row justify-content-between align-items-center mb-5 mb-lg-7">
											<div class="col-lg-5 order-lg-2 mb-5 mb-lg-0">
											...
											<div class="col-lg-6 order-lg-1">
													<img src="{{ asset('img/mockup-map-presentation.png') }}" alt="MapBox Leaflet.js Custom Integration Mockup">
											</div>
									</div>
									<div class="row justify-content-between align-items-center mb-5 mb-lg-7">
											<div class="col-lg-5 mb-5 mb-lg-0">
											...
											<div class="col-lg-6">
													<img src="{{ asset('img/mockup-calendar-presentation.png') }}" alt="Calendar Preview">
											</div>
									</div>
							</div>
					</section>
									...
									<div class="row mb-5">
											<div class="col-6 mb-5">
													<a href="./pages/dashboard/dashboard.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/overview.jpg') }}" alt="Dashboard page preview">
											...
											<div class="col-6 mb-5">
													<a href="./pages/transactions.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/transactions.jpg') }}" alt="Transactions page preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/settings.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/settings.jpg') }}" alt="Settings page preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/examples/sign-in.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/sign-in.jpg') }}" alt="Sign In page preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/examples/sign-up.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/sign-up.jpg') }}" alt="Sign Up page preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/examples/lock.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/lock.jpg') }}" alt="Lock page preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/examples/forgot-password.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/forgot-password.jpg') }}" alt="Forgot password preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/examples/reset-password.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/reset-password.jpg') }}" alt="Reset password preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/examples/404.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/404.jpg') }}" alt="404 error preview">
															<div class="text-center show-on-hover rounded-bottom">
											...
											<div class="col-6 mb-5">
													<a href="./pages/examples/500.html" class="page-preview scale-up-2">
															<img class="shadow-lg rounded scale" src="{{ asset('img/pages/500.jpg') }}" alt="500 error preview">
															<div class="text-center show-on-hover rounded-bottom">
			...
			<footer class="footer py-6 bg-gray-800 text-white">
				<div class="container">
						<div class="row">
								<div class="col-md-4">
										<img class="navbar-brand-dark mb-4" height="35" src="{{ asset('img/brand/light.svg') }}" alt="Logo light">
						...
						<div class="row">
								<div class="col mb-md-0">
										<a href="https://themesberg.com" target="_blank" class="d-flex justify-content-center">
												<img src="{{ asset('img/themesberg-logo-alt.svg') }}" height="35" class="mb-4" alt="Themesberg Logo">
										</a>
